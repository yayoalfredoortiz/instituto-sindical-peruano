...
const enrolled_courses: string[] =  ["Cursos inscritos", "Cursos activos", "Cursos completados"];
const my_courses: string[] = ["Publicado", "Pendiente", "Borrador"];
      ...
      <div className="col-lg-9">
         <div className="dashboard__content-wrap dashboard__content-wrap-two">
            <div className="dashboard__content-title">
               <h4 className="title">{style ? "Mis Cursos" : "Cursos Inscritos"}</h4>
            </div>
            <div className="row">
                                       ...
                                       <div className="courses__item-content courses__item-content-two">
                                          ...
                                          {item.progress &&
                                             <div className="progress-item progress-item-two">
                                                <h6 className="title">COMPLETO <span>{item.progress}%</span></h6>
